...
### 다중 에이전트 호출 예시 (복합 질문)
```
"최근 프리미어리그 어떤가? 그리고 5월 25일 토트넘 경기 예측해줘"
"맨유 최근 뉴스와 다음 경기 예측을 모두 알려줘"
"아스널 팀 정보와 최신 뉴스를 같이 보여줘"
```

## 기술 스택

### AI/ML
- **OpenAI GPT-4o**: 질문 분류, 뉴스 분석, 응답 생성, 다중 결과 통합
